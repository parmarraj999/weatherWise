    ...
    return (
        <div className='main-header' >
            <div style={{ display: 'flex', gap: '1.5rem' }}>
                ...
                <h2 className='ai'>Week</h2>
            </div>
            <div style={{ display: 'flex', gap: '1rem' }} >
            <div className='close-sidebar close-btn ai' style={{ marginLeft: '10px' }} onClick={closeSideBar}>
                ...
                <div style={celcius === "celcius" ? { background: "black", color: 'white' } : {}} className='degree-btn ai' onClick={changeCelcius}>°C
                    <div className='circle-anime-c' ></div>
                </div>
                <div style={celcius === "farenheit" ? { background: "black", color: 'white' } : {}} className='degree-btn ai' onClick={changeFarenheit}>°F
